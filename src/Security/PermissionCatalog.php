...
final class PermissionCatalog
{
	...
	public const array PERMISSIONS = [
		...
		'order.return' => ['Orders', 'Return order lines', 'Can create customer returns for shipped order lines.'],
		'order.refuse' => ['Orders', 'Refuse order lines', 'Can refuse remaining quantity of an order line and release its reserved stock.'],
	...
	private const array GROUP_PERMISSIONS = [
		...
		'admin' => [
			...
			'order.view', 'order.create', 'order.edit', 'order.confirm', 'order.cancel', 'order.rollback', 'order.ship', 'order.return', 'order.refuse', 'order.mark_delivered', 'order.complete', 'order.comment.manage', 'order.discount.override',
		...
		'manager' => [
			...
			'order.view', 'order.create', 'order.edit', 'order.confirm', 'order.cancel', 'order.rollback', 'order.return', 'order.refuse', 'order.comment.manage',
		...
		'stockkeeper' => [
			...
			'order.view', 'order.ship', 'order.return', 'order.mark_delivered',
			'product.view',
