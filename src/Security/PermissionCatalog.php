...
final class PermissionCatalog
{
	...
	private const array GROUP_PERMISSIONS = [
		...
		'admin' => [
			...
			'order.view', 'order.create', 'order.edit', 'order.confirm', 'order.cancel', 'order.rollback', 'order.ship', 'order.mark_delivered', 'order.complete', 'order.comment.manage', 'order.discount.override',
